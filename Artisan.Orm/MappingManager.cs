...
{
	private static readonly Dictionary<Type, Delegate> CreateObjectFuncDictionary = new();

	private static readonly Dictionary<Type, Delegate> CreateObjectRowFuncDictionary = new();

	private static readonly Dictionary<Type, Tuple<Func<DataTable>, Delegate>> CreateDataFuncsDictionary = new();

	private static readonly ConcurrentDictionary<string, Delegate> AutoCreateObjectFuncDictionary = new();

	private static readonly ConcurrentDictionary<string, Tuple<Func<DataTable>, Delegate>> AutoCreateDataFuncsDictionary = new();

	private static readonly ConcurrentDictionary<string, SqlParameter[]> SqlParametersDictionary = new();

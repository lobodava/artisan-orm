...
namespace Artisan.Orm
{
	...
	public class RepositoryBase: IDisposable
	{
		...
		private static async Task<Int32> ExecuteCommandAsync (SqlCommand cmd, CancellationToken cancellationToken = default(CancellationToken))
		{
			var returnValueParam = cmd.GetReturnValueParam();
			var isConnectionClosed = true;
		...
		/// <para/>Returns ReturnValue - the value from TSQL "RETURN [Value]" statement. If there is no RETURN in TSQL then returns 0.
		/// </summary>
		public async Task<Int32> ExecuteCommandAsync (Action<SqlCommand> action, CancellationToken cancellationToken = default(CancellationToken))
		{
			using (var cmd = CreateCommand())
			{
				cmd.AddReturnValueParam();
		...
		public async Task<Int32> ExecuteAsync (string sql, Action<SqlCommand> action, CancellationToken cancellationToken = default(CancellationToken))
		{
			using (var cmd = CreateCommand(sql, action))
			{
				cmd.AddReturnValueParam();
		...
		public async Task<T> ReadToAsync<T>(string sql, CancellationToken cancellationToken = default(CancellationToken), params SqlParameter[] sqlParameters)
		{
			using (var cmd = CreateCommand(sql, sqlParameters))
			{
		...
		public async Task<T> ReadToAsync<T>(string sql, Action<SqlCommand> action, CancellationToken cancellationToken = default(CancellationToken))
		{
			using (var cmd = CreateCommand(sql, action))
			{
				return await cmd.ReadToAsync<T>(cancellationToken);
		...
		public async Task<T> ReadAsAsync<T>(string sql, CancellationToken cancellationToken = default(CancellationToken), params SqlParameter[] sqlParameters)
		{
			using (var cmd = CreateCommand(sql, sqlParameters))
			{
		...
		public async Task<T> ReadAsAsync<T>(string sql, Action<SqlCommand> action, CancellationToken cancellationToken = default(CancellationToken))
		{
			using (var cmd = CreateCommand(sql, action))
			{
				return await cmd.ReadAsAsync<T>(cancellationToken);
		...
		public async Task<IList<T>> ReadToListAsync<T>(string sql, CancellationToken cancellationToken = default(CancellationToken), params SqlParameter[] sqlParameters)
		{
			using (var cmd = CreateCommand(sql, sqlParameters))
			{
		...
		public async Task<IList<T>> ReadToListAsync<T>(string sql, Action<SqlCommand> action, CancellationToken cancellationToken = default(CancellationToken))
		{
			using (var cmd = CreateCommand(sql, action))
			{
				return await cmd.ReadToListAsync<T>(cancellationToken);
		...
		public async Task<IList<T>> ReadAsListAsync<T>(string sql, CancellationToken cancellationToken = default(CancellationToken), params SqlParameter[] sqlParameters)
		{
			using (var cmd = CreateCommand(sql, sqlParameters))
			{
		...
		public async Task<IList<T>> ReadAsListAsync<T>(string sql, Action<SqlCommand> action, CancellationToken cancellationToken = default(CancellationToken))
		{
			using (var cmd = CreateCommand(sql, action))
			{
				return await cmd.ReadAsListAsync<T>(cancellationToken);
		...
		public async Task<ObjectRow> ReadToObjectRowAsync<T>(string sql, CancellationToken cancellationToken = default(CancellationToken), params SqlParameter[] sqlParameters)
		{
			using (var cmd = CreateCommand(sql, sqlParameters))
			{
		...
		public async Task<ObjectRow> ReadToObjectRowAsync<T>(string sql, Action<SqlCommand> action, CancellationToken cancellationToken = default(CancellationToken))
		{
			using (var cmd = CreateCommand(sql, action))
			{
				return await cmd.ReadToObjectRowAsync<T>(cancellationToken);
		...
		public async Task<ObjectRow> ReadAsObjectRowAsync(string sql, CancellationToken cancellationToken = default(CancellationToken), params SqlParameter[] sqlParameters)
		{
			using (var cmd = CreateCommand(sql, sqlParameters))
			{
		...
		public async Task<ObjectRow> ReadAsObjectRowAsync(string sql, Action<SqlCommand> action, CancellationToken cancellationToken = default(CancellationToken))
		{
			using (var cmd = CreateCommand(sql, action))
			{
				return await cmd.ReadAsObjectRowAsync(cancellationToken);
		...
		public async Task<ObjectRows> ReadToObjectRowsAsync<T>(string sql, CancellationToken cancellationToken = default(CancellationToken), params SqlParameter[] sqlParameters)
		{
			using (var cmd = CreateCommand(sql, sqlParameters))
			{
		...
		public async Task<ObjectRows> ReadToObjectRowsAsync<T>(string sql, Action<SqlCommand> action, CancellationToken cancellationToken = default(CancellationToken))
		{
			using (var cmd = CreateCommand(sql, action))
			{
				return await cmd.ReadToObjectRowsAsync<T>(cancellationToken);
		...
		public async Task<ObjectRows> ReadAsObjectRowsAsync(string sql, CancellationToken cancellationToken = default(CancellationToken), params SqlParameter[] sqlParameters)
		{
			using (var cmd = CreateCommand(sql, sqlParameters))
			{
		...
		public async Task<ObjectRows> ReadAsObjectRowsAsync(string sql, Action<SqlCommand> action, CancellationToken cancellationToken = default(CancellationToken))
		{
			using (var cmd = CreateCommand(sql, action))
			{
				return await cmd.ReadAsObjectRowsAsync(cancellationToken);
		...
		public async Task<IDictionary<TKey, TValue>> ReadToDictionaryAsync<TKey, TValue>(string sql, CancellationToken cancellationToken = default(CancellationToken), params SqlParameter[] sqlParameters)
		{
			using (var cmd = CreateCommand(sql, sqlParameters))
			{
		...
		public async Task<IDictionary<TKey, TValue>> ReadToDictionaryAsync<TKey, TValue>(string sql, Action<SqlCommand> action, CancellationToken cancellationToken = default(CancellationToken))
		{
			using (var cmd = CreateCommand(sql, action))
			{
				return await cmd.ReadToDictionaryAsync<TKey, TValue>(cancellationToken);
		...
		public async Task<IDictionary<TKey, TValue>> ReadAsDictionaryAsync<TKey, TValue>(string sql, CancellationToken cancellationToken = default(CancellationToken), params SqlParameter[] sqlParameters)
		{
			using (var cmd = CreateCommand(sql, sqlParameters))
			{
		...
		public async Task<IDictionary<TKey, TValue>> ReadAsDictionaryAsync<TKey, TValue>(string sql, Action<SqlCommand> action, CancellationToken cancellationToken = default(CancellationToken))
		{
			using (var cmd = CreateCommand(sql, action))
			{
				return await cmd.ReadAsDictionaryAsync<TKey, TValue>(cancellationToken);
